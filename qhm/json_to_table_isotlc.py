"""json_to_table_isotlc.m -- the isoTLC comparison table.

The MATLAB file is a byte-for-byte copy of json_to_table_garanzha.m, column
names included (they still say `garanzha_*`); that is preserved here rather than
"fixed", since downstream joins key off those names.
"""

import numpy as np


def json_to_table_isotlc(JS):
    import pandas as pd
